  ...
  return (
    <div className="min-h-screen grid place-items-center px-4">
      <div className="bg-white shadow-soft rounded-xl p-8 w-full max-w-sm border border-slate-200">
        ...
        <p className="text-slate-600 mb-6">Access your monitoring dashboard.</p>
        ...
        <div className="mt-4 text-sm text-slate-600">
          No account? <Link className="text-indigo-600 hover:underline" to="/register">Create one</Link>
        </div>
      </div>
    </div>
  );
